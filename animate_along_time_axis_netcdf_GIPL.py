...
freeze_fn = '/Users/malindgren/Documents/TEMP/gipl2f_freezeUp_Day_0.5m_ar5_5modelAvg_rcp85_1km_ak_Interior_EPSG3338.nc'

ds = xr.open_dataset( freeze_fn )
# arr = ds[ 'thawOut_Day' ].values
arr = ds[ 'freezeUp_Day' ].values
